...
def get_stats(full_repo_name, year_string, month_string):
    # e.g. full_repo_name: 'apache/spark', year_string: '2021', month_string = '05'
    ...
    for day in range(1, days_in_month + 1):
        ...
        for hour in range(24):
            ...
            except:  # TO DO: change except for more precise exception handling
            ...
            hour_gh_activity_spark_df = hour_gh_activity_spark_df.filter(f'name == "{full_repo_name}"')
