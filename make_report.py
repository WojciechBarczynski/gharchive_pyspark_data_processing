...
def generate_a_report(repo_stat_pd_df, repo_short_name, owner, year_string, month_string, failed_processing_pd_df):
...
'''
    ...
    failed_processing_pd_df.loc[0] = [f'2022-01-01-1']
    generate_a_report(repo_stat_df, 'Example', 'Jan Kowalski', '2020', '01', failed_processing_pd_df)
'''